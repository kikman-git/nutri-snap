...
- **`functions/`** — the trusted backend (scan lifecycle, quota, RevenueCat webhook, R2
  signing). Milestones 5–9 in `../docs/IMPLEMENTATION_MILESTONES.md` move scan processing behind it;
...
- **`../docs/PRD.md`** — product source of truth, including the §6 estimate contract and §8 data
