...
enum NutrientGuide {
    ...
    static let all: [NutrientGuideEntry] = [
        ...
        .init(name: "Vitamin D", dailyAmount: "8.5 µg",
              ...
              sources: "Sun, salmon, egg yolk · supplement common", category: .vitamins, tracked: false),
        ...
        .init(name: "Vitamin B12", dailyAmount: "2.4 µg",
              ...
              sources: "Fish, meat, eggs · vegans supplement", category: .vitamins, tracked: false),
        .init(name: "Folate (B9)", dailyAmount: "240 µg",
              benefit: "Cell renewal",
              sources: "Leafy greens, legumes", category: .vitamins, tracked: false),
